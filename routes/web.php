...
//   Route::get('/dashboard/kepala', [BerandaController::class, 'kepala'])->middleware('petugasAkses:2');
Route::get('/beranda', [BerandaController::class, 'index']);


Route::middleware(['petugasAkses:1'])->group(function () {
    ...
    // Peminjaman
    Route::middleware(['petugasAkses:1,2'])->group(function () {
    //PDF
    ...
    Route::middleware(['petugasAkses:1,3'])->group(function () {
    //Peminjaman
...
// Route::post('/DetailPinjam/create', [DetailPinjamController::class,'create']);
// Route::post('/DetailPinjam/store', [DetailPinjamController::class,'store']);
// Route::get('/DetailPinjam/edit/{idinventaris}', [DetailPinjamController::class,'edit']);
// Route::post('/DetailPinjam/update', [DetailPinjamController::class,'update']);
// Route::get('/DetailPinjam/hapus/{idinventaris}', [DetailPinjamController::class,'destroy']);
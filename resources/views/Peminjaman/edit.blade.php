      ...
      <div class="col-lg-12">
       <div class="card">
         <ol class="breadcrumb float-sm-left m-3">
           ...
           <li class="breadcrumb-item active ml-1">Edit Peminjaman</li>
         </ol>
       </div>
      </div>
    </div>
            ...
            <div class="card-body">
              ...
              <form action="/peminjaman/update" method="POST">
                  ...
                  <div class="row mt-1">
                      ...
                      <div class="col-md-8 mt-1">
                          <input type="date" name="tanggalpeminjaman" class="form-control" placeholder="Tanggal Pinjam" value="{{ $data->tanggalpeminjaman }}">
                      </div>
                  </div>
                  <div class="row mt-1">
                      <div class="col-md-4 mt-1">
                      ...
                      <div class="col-md-8 mt-1">
                          <input type="date" name="tanggalkembali" class="form-control" placeholder="Tanggal Kembali" value="{{ $data->tanggalkembali }}">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <button type="submit" class="btn btn-info mt-3">Simpan Data Peminjaman</button>
                  </div>
              </form>
              @endforeach
